                    ...
                    <div className="flex-item">
                        <div className="home-thumb">
                            <div className="section-title">
                                ...
                                <a href="YashResume_WebDev-2021.docx" download="resume/Yash_frontEnd-4-2021.docx" className="wow fadeInUp smoothScroll section-btn btn btn-success" data-wow-delay="1.4s" download>Download Resume</a>                             
                            </div>
                        </div>
                    </div>
                </div>
